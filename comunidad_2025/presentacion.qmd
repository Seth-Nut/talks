...
::: {.fragment style="display: flex; justify-content: center; align-items: center; padding: 1rem;"}
<iframe src="images/pyvizzu/mystory3.html" width="1000" height="600" style="border: 4px solid #ccc; border-radius: 12px; box-shadow: 0 0 20px rgba(0,0,0,0.2);">
...
::: {style="max-height: 300px; overflow: auto; border: 1px solid #ccc; padding: 1em; border-radius: 8px;"}
```{pyodide-python}
...
::: {style="max-height: 400px; overflow: auto; border: 1px solid #ccc; padding: 1em; border-radius: 8px;"}
```{pyodide-python}
import pandas as pd
