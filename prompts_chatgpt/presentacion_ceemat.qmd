...
## 🤖 Actividad: Matemáticas + Python {background-image="images/background.jpg" background-opacity="0.25"}

::: {.callout-tip title="Objetivo"}
Usar un chatbot como ChatGPT para resolver problemas de matemáticas programados en Python.
:::

* Lee el enunciado y trata de resolverlo e código.
...
> 👉 [Ver actividad completa](https://colab.research.google.com/drive/1ODwmEIyX_1fQsI08pWiILYC_OvrOv8FZ?usp=drive_link)
