...
<img src="images/viz/teoria_vis.png" alt="teoria visualización" style="display: block; margin: 0 auto; width: 20%;">
...
::: {.column width="60%"}
&#32;<br>
Un sistema abierto para publicaciones científicas y técnicas, centrado en markdown, documentos dinámicos e interactivos con código (Python/R/Julia).
:::
::: {.column width="40%"}
...
## Jupyter + RISE {background-image="images/background.jpg" background-opacity="0.25"}
...
<img style="width:50%;" src="./images/streamlit/Streamlit-Prophet.gif">
...
## Flujo de decisión {background-image="images/background_slides3.png" background-opacity="0.3"}
...
## Conclusión {background-image="images/background_slides3.png" background-opacity="0.3"}
...
* **🛠️ Herramientas**: Streamlit, Quarto, y Python para presentaciones interactivas.
:::
