...
::: columns
::: {.column width="60%"}
<br> Un sistema abierto para publicaciones científicas y técnicas, centrado en markdown, documentos dinámicos e interactivos con código (Python/R/Julia).
:::
...
<img src="./images/rise/basic_usage.gif" style="width:80%;"/>
...
::: columns
::: {.column width="60%"}
<br><br> Streamlit es una herramienta de código abierto que permite crear aplicaciones web interactivas usando solo Python.
:::
