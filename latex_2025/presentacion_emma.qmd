...
## 📄 Actividad: Proyecto en Overleaf {background-image="images/background.jpg" background-opacity="0.25"}
...
3. **Edita**: título, sección, imagen, ecuación y tabla.
4. **Compila** y revisa.
...
::: {.column width="45%"}
::: {style="text-align: center;"}
<img src="images/tool.png" alt="Escribir Informe" style="width: 100%; border-radius: 10px;"/>
:::
:::
...
![](images/tool3.png){.fragment .fade-in-then-out fig-align="center" width="85%"}

![](images/tool4.png){.fragment .fade-in-then-out fig-align="center" width="85%"}
...
> <span style="font-size:0.85em;">🤖 **Consejo**: usa prompts claros, incluye tu código y pide explicaciones paso a paso.</span>
...
## 📄 Actividad: CV en Overleaf {background-image="images/background.jpg" background-opacity="0.25"}
...
1. **Abre** la [plantilla de CV](https://www.overleaf.com/read/gxqqsjhzfvdc#f623dc) en Overleaf.
2. **Completa y personaliza** datos, experiencia y habilidades.
3. *(Opcional)* Mejora el texto con ChatGPT o Gemini.
4. **Compila** y revisa.
...
::: {.fragment}
✅ **LaTeX** permite crear documentos académicos con formato profesional. <br>
✅ Ofrece **control total** sobre estilo y estructura.<br>
✅ Hay muchas **herramientas** que lo hacen más fácil de usar.<br>
✅ Con **IA**, escribir en LaTeX es aún más eficiente.<br>
✅ **Overleaf** permite comenzar sin instalar nada.<br>
::: 
