...
![](images/tools3.png){.fragment .fade-in-then-out fig-align="center" width="80%"}
...
::: fragment
✅ **LaTeX** permite crear documentos académicos con formato profesional. <br> ✅ Ofrece **control total** sobre estilo y estructura.<br> ✅ Hay muchas **herramientas** que lo hacen más fácil de usar.<br> ✅ Con **IA**, escribir en LaTeX es aún más eficiente.<br> ✅ **Overleaf** permite comenzar sin instalar nada.<br>
:::
