...
:::: {style="display: flex; justify-content: center; align-items: center; height: 60vh; flex-direction: column; text-align: center; font-size: 4rem;"}
::: callout-note
...
[Storytelling]{style="font-size: 1.5em"}

[Why Storytelling?]{style="font-size: 3em"}
:::
...
[Data Storytelling]{style="font-size: 1.5em"}

[Tool #1: Visualization]{style="font-size: 3em"}
:::
...
[Tool #3: Presentation]{style="font-size: 3em"}
:::
...
![](https://miro.medium.com/v2/resize:fit:1400/1*6BWaj0W5VZLXvvuygeJQhg.gif){width="90%"}
...
![](https://docs.streamlit.io/images/streamlit-community-cloud/workspace-view-only.png){.fragment fig-align="center" width="90%"}
:::
...
[Conclusion]{style="font-size: 3em"}
:::
...
> 🔗 Visit our official site: [sethnut.com/talks](https://sethnut.com/talks/)
