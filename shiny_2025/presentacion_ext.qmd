...
[Activity]{style="font-size: 1.5em"}
:::
...
## 🧪 Activity: Your First Dashboard {background-image="images/background.jpg" background-opacity="0.15"}
...
Learn how to build a simple dashboard using **Google Looker Studio** with data from Google Sheets and share it with your classmates.
...
* Connect a Google Sheet  
   [📄 Example dataset](https://docs.google.com/spreadsheets/d/1dZ94l2MPnA9I0A6hWlt5O1ZMg64DKJ6dL1hf9T3zEf4/edit?usp=sharing)  
*  Add:
   - Table with filter, Bar chart, Scorecards (KPIs)  
*  Customize design  
...
* Create a new dashboard  
   ...
   - Add filters and custom style  
*  Share the link and give feedback to one peer
...
| Title and custom design                   |             |
| Proper data source connection             |             |
| Commented on a classmate’s dashboard      |             |
