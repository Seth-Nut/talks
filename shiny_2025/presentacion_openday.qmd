...
[Crea, Innova y Presenta]{.custom-title}

[Data Storytelling + A.I.]{.custom-subtitle}

[Francisco Alfaro Medina <br> Juan Etchebarne Arias]{.custom-author}
...
::: fragment
![](images/about3.svg){fig-align="center"}
:::
...
<div style="text-align:center; font-size:25px; font-family:sans-serif;">
  <span style="color:green; font-weight:bold;">Más fácil de distinguir</span>
  <span style="margin: 0 15px; font-size:18px; background: linear-gradient(to right, green, orange, red); -webkit-background-clip: text; color: transparent;">
    ⟵────────────────────────────⟶
  </span>
  <span style="color:red; font-weight:bold;">Más difícil de distinguir</span>
</div>
