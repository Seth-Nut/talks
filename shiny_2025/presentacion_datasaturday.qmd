...
format: 
  revealjs:
    ...
    title-slide-attributes: 
      data-background-image: images/slide-normal.jpg
filters:
...
##  {#hello-quarto-title data-menu-title="Hola Quarto" background-image="images/Slide33.jpg" data-state="no-logo"}

##  {#hello-quarto-title data-menu-title="Hola Quarto" background-image="images/Slide4.jpg" data-state="no-logo"}

## Sobre Nosotros {background-image="images/slide-normal.jpg" }

::: fragment
![](images/about.svg){fig-align="center"}
:::

## Agenda {background-image="images/slide-normal.jpg" }
...
## Agenda (v2) {background-image="images/slide-normal.jpg"}
...
## Qué es Storytelling? {background-image="images/slide-normal.jpg"}
...
## Qué es Data Storytelling? {background-image="images/slide-normal.jpg"}
...
## Cuando las estadísticas confunden ... {background-image="images/slide-normal.jpg"}
...
## El poder del qué y cómo visualizar {background-image="images/slide-normal.jpg"}
...
## Ohh, nuestros cerebros son hackables... {background-image="images/slide-normal.jpg"}
...
## Atención y memoria {background-image="images/slide-normal.jpg"}
...
## Narrativa {background-image="images/slide-normal.jpg"}
...
## Más que gráficos bonitos {background-image="images/slide-normal.jpg"}
...
## Ejemplo: Spotify Wrapped {background-image="images/slide-normal.jpg"}
...
## Visualización ... {background-image="images/slide-normal.jpg"}
...
## Mejores Gráficos para tus Datos {background-image="images/slide-normal.jpg"}
...
## 4 Pilares Visualización - Noah Iliinsky {background-image="images/slide-normal.jpg"}
...
## Herramientas {background-image="images/slide-normal.jpg"}

::: r-stack
![](images/toolsbi.png){.fragment .fade-in-then-out fig-align="center" width="100%"}

![](https://web.mat.upc.edu/joaquim.puig/posts/quarto-ojs/quarto-ojs.gif){.fragment .fade-in-then-out fig-align="center" width="80%"}

![](https://blog.streamlit.io/content/images/2022/04/Live-Data-Science-Dashboard-GIF-1.gif){.fragment .fade-in-then-out fig-align="center" width="100%"}

![](https://images.ctfassets.net/2vbtnveccz5s/2iorjhUm2wp4EEHv4kDKiV/4cb6e193184f1fc88547f25272e8f976/specialized1.gif){.fragment .fade-in-then-out fig-align="center" width="100%"}
...
## De las Ideas al Impacto ... con IA {background-image="images/slide-normal.jpg"}
...
## 🤖 Caso de Estudio {background-image="images/slide-normal.jpg"}
...
## 🎉 ¡Gracias por Participar! {background-image="images/slide-normal.jpg"}
