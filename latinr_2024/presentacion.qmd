...
format: 
  revealjs:
    ...
    slide-attributes:
      data-background-image: images/background.jpg
    logo: latinr_logo.png
---




## 🚀 Introducción {background-image=images/background.jpg}
...
::::
:::: {.column width=50%}
<br>**Quarto** permite crear contenidos interactivos y combinar varios lenguajes en un solo entorno educativo.
::::
:::

---

## 🌐 Quarto WebR y Quarto Pyodide {background-image=images/background.jpg}
...
## 📊 Ejemplo R {background-image=images/background.jpg}
...
## 📊 Ejemplo Python {background-image=images/background.jpg}
...
## 🎓 Quarto y la Enseñanza {background-image=images/background.jpg}
...
## 🛠️ Implementación  {background-image=images/background.jpg}
...
## 🎓 Talleres {background-image=images/background.jpg}
...
## 📊 Resultados {background-image=images/background.jpg}
...
## 📚 Recursos Adicionales {background-image=images/background.jpg}
...
## 🎉 ¡Gracias por Participar! {background-image=images/background.jpg}
