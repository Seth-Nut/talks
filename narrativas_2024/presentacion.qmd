...
::: {.r-stack}
![](images/Honestidad2.png){.fragment .fade-in-then-out width="60%"}

![](images/male_height.jpg){.fragment .fade-in-then-out width="200%"}

![](images/nba.png){.fragment width="600%"}
...
[Página de Seaborn](https://seaborn.pydata.org/)
---
